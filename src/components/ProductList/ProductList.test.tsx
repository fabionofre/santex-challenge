...
describe('ProductListComponent', () => {
    ...
    test('Should render product list on page 2', async () => {
        ...
        await waitFor(() => {
            const paginationItem2 = getByTestId('pagination-item-2');;
            fireEvent.click(paginationItem2);
            expect(paginationItem2.getAttribute("data-active")).toBe("true");
        });
    });
});
